...
if ($volume) {
    ...
    if ($volume == '50ml') {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM defuser WHERE capacity_1 = 50";
    } elseif ($volume == '100ml') {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM defuser WHERE capacity_2 = 100";
    } elseif ($volume == 'large') {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM defuser WHERE capacity_3 = 200";
    } else {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM defuser";
    }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="sidebar">
            <h2>카테고리</h2>
            <a href="defuser.php?volume=50ml">
                <div>50ml</div>
            </a>
            <a href="defuser.php?volume=100ml">
                <div>100ml</div>
            </a>
            <a href="defuser.php?volume=large">
                <div>대용량(200ml)</div>
            </a>
        </div>
