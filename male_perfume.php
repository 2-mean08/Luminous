...
if ($volume) {
    ...
    if ($volume == '30ml') {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM male_perfume WHERE capacity_1 = 30";
    } elseif ($volume == '60ml') {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM male_perfume WHERE capacity_2 = 60";
    } elseif ($volume == 'large') {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM male_perfume WHERE capacity_3 = 100";
    } else {
        $sql = "SELECT content_code, content_img, deliv_today, content_name, discount_rate, content_cost, content_price 
                FROM male_perfume";
    }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="sidebar">
            <h2>카테고리</h2>
            <a href="male_perfume.php?volume=50ml">
                <div>30ml</div>
            </a>
            <a href="male_perfume.php?volume=100ml">
                <div>60ml</div>
            </a>
            <a href="male_perfume.php?volume=large">
                <div>대용량(100ml)</div>
            </a>
        </div>
            ...
            <div class="products-container">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="male_detail.php?content_code=' . $row['content_code'] . '">';
