    ...
    <header class="header" id="mainHeader" tabindex="0">
        ...
        <nav class="nav" role="menubar">
            ...
            <div class="nav-item" role="menuitem" tabindex="0">
                ...
                <div class="submenu">
                    <!-- 직접 지정한 메뉴 이름과 content_fild 값 -->
                    <a href="product.php?content_fild=galaxy_s25">
                        <p>갤럭시 S25 시리즈</p>
                    </a>
                    <a href="product.php?content_fild=iphone_16">
                        <p>아이폰 16 시리즈</p>
                    </a>
                    <a href="product.php?content_fild=samsung">
                        <p>삼성</p>
                    </a>
                    <a href="product.php?content_fild=apple">
                        <p>애플</p>
                    </a>
                    <a href="product.php?content_fild=etc_models">
                        <p>기타 기종</p>
                    </a>
                    <a href="product.php?content_fild=accessories">
                        <p>악세사리</p>
                    </a>
                </div>
            </div>
